...
class Boards(models.Model):
    ...
    register = models.ForeignKey('User', db_column='register', related_name='board_register', blank=True, null=True, on_delete=models.CASCADE)
    regdate = models.DateTimeField(auto_now_add=True, blank=True, null=True)
...
class Receipts(models.Model):
    ...
    register = models.ForeignKey('User', db_column='register', blank=True, null=True, on_delete=models.CASCADE)
    regdate = models.DateTimeField(blank=True, null=True)
    board = models.ForeignKey(Boards, blank=True, null=True, on_delete=models.CASCADE)
